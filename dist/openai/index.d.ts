...
export declare const PUBLIC_CLAWD_REFERENCE_TOOLS: readonly ["get-fee-tier", "list-skills", "get-skill"];
export declare const DEFAULT_PUMP_MCP_URL = "https://solgpt.trade/plugin/mcp";
...
export declare function createPumpMcpTool(options?: {
    ...
    allowed_tools: ("get-fee-tier" | "list-skills" | "get-skill" | "get-token-info")[];
