export function createClawdComputeWebMCPTools(adapters) {
    return [
        {
        ...
        },
        {
            ...
            description: "Run an AI inference request through Clawd Compute. This may consume metered compute; the page should show any required payment or quota before consequential payment execution.",
            inputSchema: {
                type: "object",
                properties: {
            ...
            execute: async (input) => adapters.runInference(input),
        },
    ];
}
