...
export function createPumpWebMCPTools(client: PumpLiveClient = createDefaultPumpClient()): WebMCPTool[] {
  return [
    {
      name: "pump.get_relay_health",
      title: "Get Pump.fun relay health",
      description:
        "Read live Pump.fun relay health through x402 agency at https://x402.life/pump/mcp. Does not sign or trade.",
    ...
    },
    {
      ...
      description:
        "Collect recent pump.fun token launches through x402 agency at https://x402.life/pump/mcp. Read-only live tape.",
      inputSchema: {
        type: "object",
        properties: {
